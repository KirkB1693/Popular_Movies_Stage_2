  ...
  /*  private static final String LOG_TAG = NetworkUtils.class.getSimpleName();
    ...
    *//**
    ...
    public static URL getUrl(Context context) {
        if (MoviePreferences.isLocationLatLonAvailable(context)) {
            double[] preferredCoordinates = MoviePreferences.getLocationCoordinates(context);
            double latitude = preferredCoordinates[0];
            double longitude = preferredCoordinates[1];
            return buildUrlWithLatitudeLongitude(latitude, longitude);
        } else {
            String locationQuery = MoviePreferences.getPreferredWeatherLocation(context);
